...
export default function MonitoringPage() {
  ...
  return (
    <Container>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Monitoramento de Vida Útil</h1>
        <p className="text-gray-600 dark:text-gray-400">Acompanhe o estado e desgaste de cada componente</p>
      </div>
